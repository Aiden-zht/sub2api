  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        enabledPaymentTypes: 'Enabled Payment Methods',
        enabledPaymentTypesHint: 'This controls checkout buttons. After enabling XunhuPay or EasyPay, create the matching provider configuration below.',
